...
| Harness | Inspect skills, subagents, hooks, and MCP placeholders | `examples/starter_article/.cursor/`, `examples/hooks/`, `examples/cursor/.cursor/mcp.json.example` |
| Tool lanes | Choose Codex, Claude Code, or Cursor path | `materials/tool_tracks.md`, `examples/{codex,codex-app,claude,claude-app,cursor}/` |
